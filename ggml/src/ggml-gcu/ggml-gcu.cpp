...
//
// gcu_async_disabled / gcu_queued_ops_disabled / gcu_release_scratch and
// the per-context scratch helpers now live in gcu_op_elementwise.cpp;
// declared via gcu_ops.h.
