// ggml-gcu: matmul op handlers — MUL_MAT, MUL_MAT_ID.
//
// Per the file layout in
// docs/superpowers/specs/2026-05-10-gcu-mvp5c-file-split-design.md, this
// is the largest single op family by LoC: it carries the F32/F16/BF16
// dtype matrix, the Q-typed dequant-on-load weight path, the input/
// output cast scratch, and the MoE expert routing/broadcast cases.
// gcu_get_zero_bias supplies the mandatory bias arg for topsatenLinear.
